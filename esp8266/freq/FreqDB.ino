...
void loop()
{
 ...
 // microseconds_finished = micros();
 // ConversionTime = microseconds_finished - microseconds_start;
 ...
 // Serial.println(ConversionTime);
  ...
  // időméréshez most nem kell, 
 // if (!client.connected()) {
 //   reconnect();
 // }
 // client.loop();

  //snprintf (msg, MSG_BUFFER_SIZE, "eszterga,rpm=%f", value);
  int j;
